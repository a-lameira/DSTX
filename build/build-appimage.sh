...
apt-get update
apt-get install -y meson ninja-build valac pkg-config wget gettext desktop-file-utils libgtk-4-dev libadwaita-1-dev libgee-0.8-dev libjson-glib-dev librsvg2-dev
...
/work/linuxdeploy-extracted/AppRun --appdir /work/AppDir --plugin gtk --output appimage --verbose
